...
const hashP = [
    ...
    { text: "Capacitaciones para cuidadores y cuidadoras de personas mayores en salud mental y física y autocuidado"},
    ...
    { text: "Talleres de herramientas prácticas para adolescencias e infancias"},
